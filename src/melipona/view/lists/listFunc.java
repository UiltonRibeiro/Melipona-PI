 ...
 * @author uilto
 */
public class listFunc extends javax.swing.JDialog {

    /**
     * Creates new form listClient
     */
    public listFunc(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
        preencherAll(service.AllFuncionario());
    }
    ...
    private void bntImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntImportActionPerformed
        ...
        if(tblClientes.getSelectedRow() > -1 ){
            int IdFuncionario = Integer.parseInt((String) tblClientes.getValueAt(tblClientes.getSelectedRow(), 0)) ;
            setFuncionarioSelect(service.getFuncionario(IdFuncionario)); 
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                listFunc dialog = new listFunc(new javax.swing.JFrame(), true);
    ...
    public Funcionario FuncionarioSelect;
    ...
    public void preencherAll(List<Funcionario> listFuncionario){
       
        String columns[] = {"ID","nome", "CPF","Cargo"};
        String dados[][] = new String[listFuncionario.size()][columns.length];
        int i=0;
